...
<div class="modal fade" id="staticBackdrop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <section class="mt-60">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-9">
                    <h2 class="text-blue mb-4">Villa Experience</h2>
                </div>
                <div class="col-12 col-md-3 my-auto text-end">
    ...
    <section class="bg-ig pt-100 pb-100">
        <div class="container mb-5">
            ...
            <p>Reach out our Instagram Account @villanelayan</p>
            <a href="https://www.instagram.com/villanelayan/" class="btn btn-outline-red rounded-0">Follow Us</a>
        </div>
